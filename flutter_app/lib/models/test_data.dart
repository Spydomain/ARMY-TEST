...
final List<Question> _allQuestions = [
  ...
  Question(
    ...
    title: {'en': 'Identify the vehicle in the image.', 'fr': 'Identifiez le véhicule dans l\'image.'},
    options: {'en': ['BMD-2', 'BMP-2', 'BMD-1', 'BTR-70'], 'fr': ['BMD-2', 'BMP-2', 'BMD-1', 'BTR-70']},
    correctAnswerIndex: 0,
    correctAnswer: {'en': 'BMD-2', 'fr': 'BMD-2'},
    description: {'en': 'The BMD-2 is a Soviet airborne infantry fighting vehicle, introduced in 1985.', 'fr': 'Le BMD-2 est un véhicule de combat d\'infanterie aéroporté soviétique, introduit en 1985.'},
  ),
